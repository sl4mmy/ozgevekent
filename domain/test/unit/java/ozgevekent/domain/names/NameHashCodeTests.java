...
public class NameHashCodeTests {

        @Test
        public void shouldBeFortyTwoWhenNameValueIsNull() throws Exception {
        ...
        public void shouldBeNameValueHashCodeWhenNameValueIsNotNullOrEmpty() throws Exception {
                ...
                assertEquals(expected, name.hashCode());
        }

        public static junit.framework.Test suite() {
                return new JUnit4TestAdapter(NameHashCodeTests.class);
        }
}
