...
public class StreetEqualityTests {
        ...
        public void shouldEqualDifferentInstanceWhenBothComponentsAreNull() throws Exception {
                final Street left = new Street(null);
                final Street right = new Street(null);
        ...
        @Test
        public void shouldNotEqualDifferentInstanceWhenComponentsAreNullAndOtherComponentsAreNotNull()
            throws Exception {
                final Street left = new Street(null);
                final Street right = new Street("DOES", "NOT", "MATTER");
        ...
        @Test
        public void shouldNotEqualDifferentInstanceWhenComponentValuesAreNullAndOtherComponentValuesAreNotNull()
            throws Exception {
                final Street left = new Street(null, null, null);
                final Street right = new Street("DOES", "NOT", "MATTER");
        ...
        @Test
        public void shouldNotEqualDifferentInstanceWhenComponentsAreNotNullAndOtherComponentsAreNull()
            throws Exception {
                final Street left = new Street("DOES", "NOT", "MATTER");
                final Street right = new Street(null);
        ...
        @Test
        public void shouldNotEqualDifferentInstanceWheComponentValuesAreNotNullAndOtherComponentsValuesAreNull()
            throws Exception {
                final Street left = new Street("DOES", "NOT", "MATTER");
                final Street right = new Street(null, null, null);
