...
public class StreetHashCodeTests {
        ...
        @Test
        public void shouldBeFortyTwoWhenComponentsAreNull() throws Exception {
                final Street street = new Street(null);

                assertEquals(42, street.hashCode());
        }

        @Test
        public void shouldBeFortyTwoWhenComponentsAreEmpty() throws Exception {
        ...
        @Test
        public void shouldBeComponentsHashCodeWhenComponentsIsValued() throws Exception {
        ...
        public static junit.framework.Test suite() {
                return new JUnit4TestAdapter(StreetHashCodeTests.class);
        }
}
