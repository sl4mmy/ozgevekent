...
public class CountryHashCodeTests {

        @Test
        public void shouldBeFortyTwoWhenCountryValueIsNull() throws Exception {
        ...
        public void shouldBeCountryValueHashCodeWhenCountryValueIsNotNullOrEmpty() throws Exception {
                ...
                assertEquals(expected, country.hashCode());
        }

        public static junit.framework.Test suite() {
                return new JUnit4TestAdapter(CountryHashCodeTests.class);
        }
}
