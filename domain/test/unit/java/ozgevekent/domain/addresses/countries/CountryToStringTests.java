...
public class CountryToStringTests {

        @Test
        public void shouldBeEmptyStringWhenCountryValueIsNull() throws Exception {
        ...
        public static junit.framework.Test suite() {
                return new JUnit4TestAdapter(CountryToStringTests.class);
        }
}
